...
const replSetGetStatus = require('mongodb/lib/operations/admin_ops').replSetGetStatus;
const serverStatus = require('mongodb/lib/operations/admin_ops').serverStatus;
const validateCollection = require('mongodb/lib/operations/admin_ops').validateCollection;
