<template>
  ...
  <div class="row">
    ...
    <duyi-button round type="danger">danger按钮</duyi-button>
  ...
  <div class="row">
    ...
    <duyi-button type="success" icon="coffee" circle></duyi-button>
    ...
    <duyi-button type="warning" icon="milk-tea" @click="clickHandle">奶茶</duyi-button>
  </div>
  </div>
</template>
