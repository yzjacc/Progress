...
Object.defineProperty(exports, "ConfigType", {
  enumerable: true,
  get: function get() {
    return _bundlerUtils().ConfigType;
  }
});
...
class Bundler {
  ...
  setupDevServerOpts({
    ...
    const compiler = bundleImplementor(bundleConfigs); // @ts-ignore

    const compilerMiddleware = (0, _webpackDevMiddleware().default)(compiler, {
      publicPath: '/',
      logLevel: 'silent',
      watchOptions: {
        ignored: process.env.WATCH_IGNORED === 'none' ? undefined : new RegExp(process.env.WATCH_IGNORED || 'node_modules')
      }
    });
