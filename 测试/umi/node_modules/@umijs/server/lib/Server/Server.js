...
class Server {
    ...
    if (!Array.isArray(this.opts.proxy)) {
      if (this.opts.proxy && 'target' in this.opts.proxy) {
        ...
        this.opts.proxy = Object.keys(this.opts.proxy || {}).map(context => {
          var _this$opts$proxy;

          let proxyOptions; // For backwards compatibility reasons.

          const correctedContext = context.replace(/^\*$/, '**').replace(/\/\*$/, '');

          if (typeof ((_this$opts$proxy = this.opts.proxy) === null || _this$opts$proxy === void 0 ? void 0 : _this$opts$proxy[context]) === 'string') {
            proxyOptions = {
              context: correctedContext,
              target: this.opts.proxy[context]
            };
          } else {
            var _this$opts$proxy2;

            proxyOptions = _objectSpread({}, ((_this$opts$proxy2 = this.opts.proxy) === null || _this$opts$proxy2 === void 0 ? void 0 : _this$opts$proxy2[context]) || {}, {
              context: correctedContext
            });
          }
  ...
  createServer() {
    ...
    if (httpsOpts) {
      if (_utils().semver.gte(process.version, '10.0.0') && !this.isHttp2()) {
        this.listeningApp = _https().default.createServer(httpsOpts, this.app);
      } else {
        this.listeningApp = require('spdy').createServer(httpsOpts, this.app);
      }
    } else {
      this.listeningApp = _http().default.createServer(this.app);
    }
  }
