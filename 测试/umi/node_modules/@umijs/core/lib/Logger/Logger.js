...
class Logger extends _Common.default {
  ...
  log(...args) {
    ...
    process.stdout.write(_utils().chalk.black.bgBlue('LOG') + ' ');
    console.log(...args);
  }
  /**
  ...
  error(...args) {
    if (this.isUmiError(args === null || args === void 0 ? void 0 : args[0])) {
      ...
      process.stderr.write(_utils().chalk.black.bgRed('ERROR') + ' ');
      console.error(...args);
    }
  }

  warn(...args) {
    process.stderr.write(_utils().chalk.black.bgHex('#faad14')('WARN') + ' ');
    console.warn(...args);
  }
  ...
  profile(id, message) {
    ...
    if (this.profilers[id]) {
      ...
      process.stderr.write(_utils().chalk.black.bgCyan('PROFILE') + ' ');
      msg = `${_utils().chalk.black.bgCyan('PROFILE')} ${_utils().chalk.cyan(`└ ${namespace}`)} Completed in ${this.formatTiming(time - timeEnd)}`;
      console.log(msg);
    } else {
      msg = `${_utils().chalk.black.bgCyan('PROFILE')} ${_utils().chalk.cyan(`┌ ${namespace}`)} ${message || ''}`;
      console.log(msg);
    }
