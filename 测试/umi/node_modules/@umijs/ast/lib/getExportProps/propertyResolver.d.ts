...
export declare const NODE_RESOLVERS: (IResolver<t.StringLiteral> | IResolver<t.NumericLiteral> | IResolver<t.BooleanLiteral> | IResolver<t.NullLiteral> | IResolver<t.Identifier> | IResolver<t.ObjectExpression> | IResolver<t.ArrayExpression> | IResolver<t.FunctionExpression> | IResolver<t.ArrowFunctionExpression>)[];
