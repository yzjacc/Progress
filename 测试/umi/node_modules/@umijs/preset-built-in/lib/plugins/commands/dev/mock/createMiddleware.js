...
function _default(opts = {}) {
  ...
  watcher.on('ready', () => debug('Initial scan complete. Ready for changes')).on('all', (event, file) => {
    var _updateMockData;
    ...
    data = (_updateMockData = updateMockData()) === null || _updateMockData === void 0 ? void 0 : _updateMockData.mockData;
