  ...
  _getBundleAndConfigs = _asyncToGenerator(function* ({
      ...
      _getConfig = _asyncToGenerator(function* ({
        ...
        const getConfigOpts = yield api.applyPlugins({
          ...
          initialValue: {
            ...
            type,
            port,
            hot: type === _bundlerWebpack().ConfigType.csr && process.env.HMR !== 'none',
            entry: {
    ...
    const bundleConfigs = yield api.applyPlugins({
      ...
      initialValue: [yield getConfig({
        type: _bundlerWebpack().ConfigType.csr
      }), api.config.ssr && (yield getConfig({
        type: _bundlerWebpack().ConfigType.ssr
      }))].filter(Boolean),
      args: _objectSpread({}, bundlerArgs, {
        getConfig
      })
