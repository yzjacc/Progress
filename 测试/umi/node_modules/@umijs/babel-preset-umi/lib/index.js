...
var _default = (context, opts = {}) => {
  ...
  return {
    ...
    plugins: [// Necessary to include regardless of the environment because
    ...
    [require('@babel/plugin-transform-destructuring').default, {
      ...
      proposal: 'minimal'
    }], require('@babel/plugin-proposal-do-expressions').default, require('@babel/plugin-proposal-function-bind').default, opts.transformRuntime && [require('@babel/plugin-transform-runtime').default, _objectSpread({
    ...
    }) : []), opts.lockCoreJS3 && [require.resolve('@umijs/babel-plugin-lock-core-js-3'), opts.lockCoreJS3]].filter(Boolean)
  };
};
